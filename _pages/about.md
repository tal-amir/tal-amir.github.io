...
- **Mar 2026** — A Python/CUDA implementation of the [Trimmed Lasso / GSM solver](https://pypi.org/project/sparse-approx-gsm/) is now available on PyPI as `sparse-approx-gsm`. Many thanks to [Shachar Cohen](https://github.com/Shaharcohe) (Weizmann) for this contribution!
...
- **2025** — [Fourier Sliced-Wasserstein Embedding](https://tal-amir.github.io/publication/2024-05%20Fourier%20Sliced-Wasserstein%20Embedding) accepted to ICLR 2025.
