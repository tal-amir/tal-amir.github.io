...
- In this [LoG 2025 paper](https://tal-amir.github.io/publication/2024-10%20FSWGNN), we extend our approach to graphs, introducing the first graph neural network with bi-Lipschitz Weisfeiler-Leman (WL) separation power. Our model provides bounded-distortion guarantees with respect to two standard graph metrics, and is competitive with standard MPNNs while being more accurate on long-range tasks.
